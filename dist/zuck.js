...
module.exports = function (window) {
  ...
  var ZuckJS = function ZuckJS(timeline, options) {
    ...
    var timeAgo = function timeAgo(time) {
      ...
      var formats = [[60, " ".concat(language.seconds), 1],
      // 60
      [120, "1 ".concat(language.minute), ''],
      // 60*2
      [3600, " ".concat(language.minutes), 60],
      // 60*60, 60
      [7200, "1 ".concat(language.hour), ''],
      // 60*60*2
      [86400, " ".concat(language.hours), 3600],
      // 60*60*24, 60*60
      [172800, " ".concat(language.yesterday), ''],
      // 60*60*24*2
